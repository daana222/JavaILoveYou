...
public class PM extends javax.swing.JFrame {
    ...
    public PM() {
        initComponents();
        setSize(890, 500); // Set frame size explicitly (if needed)
    ...
    private void initComponents() {
        ...
        label1.getAccessibleContext().setAccessibleName("lblPM");
        jButton2.getAccessibleContext().setAccessibleName("btnPMItems");
        jButton1.getAccessibleContext().setAccessibleName(" btnPMSuppliers");
        jComboBox1.getAccessibleContext().setAccessibleName("cbRequisition");
